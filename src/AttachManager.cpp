...
void AttachManager::ProcessButtonHeld(std::uint32_t a_key, bool a_altKeyHeld) const
{
...
void AttachManager::ProcessButtonDown(std::uint32_t a_key, bool a_altKeyHeld)
{
	static auto settings = Settings::GetSingleton();
